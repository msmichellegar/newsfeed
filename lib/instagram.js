...
module.exports = {
    ...
    getPics: function(token, callback) {
        ...
        request('https://api.instagram.com/v1/users/1655822653/media/recent/?access_token=' + token + '&count=5&scope=public_content', function (error, response, body) {
